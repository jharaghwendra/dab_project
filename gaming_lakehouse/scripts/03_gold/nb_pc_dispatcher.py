...
#   Layer 1 — dbt Python model (dbt_gold/models/marts/mart_player_activity_summary.py)
...
#
# RUN CADENCE:
#   Triggered by Databricks Workflow after dbt run --select mart_player_activity_summary.
...
CATALOG = "igaming_dev"
SCHEMA = "gold"
TABLE = "mart_player_activity_summary"
...
#   FROM igaming_dev.gold.mart_player_activity_summary
