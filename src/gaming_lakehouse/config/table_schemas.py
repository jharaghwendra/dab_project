...
_IG_PLAYER_SCHEMA = StructType(
    [
        ...
        StructField("player_alias", StringType(), True),
        StructField("region_code", StringType(), True),
        StructField("account_tier", StringType(), True),
        StructField("segment_ids", StringType(), True),
        StructField("tags", StringType(), True),
        StructField("is_verified", ByteType(), True),
        StructField("is_identity_verified", ByteType(), True),
        StructField("is_contact_verified", ByteType(), True),
...
TABLE_CONFIGS: dict[str, TableConfig] = {
    "ig_transaction": TableConfig("transaction_id", _IG_TRANSACTION_SCHEMA, "record_version"),
    ...
    "ig_compliance_check": TableConfig("check_id", _IG_COMPLIANCE_CHECK_SCHEMA, "modified_at"),
    ...
    "ig_brand_game_catalog": TableConfig("brand_game_id", _IG_BRAND_GAME_CATALOG_SCHEMA, "updated_at"),
